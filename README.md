# Burger Shop 2 — Nintendo Switch port

A native Switch wrapper for **Burger Shop 2** (GoBit Games), the Android build of
...
You must own Burger Shop 2. This repository distributes only original wrapper code
